...
export default class AnswersController {
    async index({ request, response }) {
        const { params: { question_id: questionId }, } = await request.validateUsing(indexValidator);
    ...
    async store({ request, response }) {
        const { params: { question_id: questionId }, message, } = await request.validateUsing(storeValidator);
...
//# sourceMappingURL=answers_controller.js.map